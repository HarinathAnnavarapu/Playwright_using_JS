...
async function main(){
    ...
    signUpToSlack().then((value) => {
        console.log(`On success of signUpToSlack - ${value}`)
        addProfilePic().then((value) => {
            console.log(`On success of addProfilePic - ${value}`)
            postNotificationInIntroChannel().then((value) => {
                console.log(`On success of postNotificationInIntroChannel - ${value}`)
            })
            finalStatusPrint()
        })
    }).catch((err) => {
